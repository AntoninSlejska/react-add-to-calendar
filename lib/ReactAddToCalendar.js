...
var _components = {
  ReactAddToCalendar: {
    displayName: "ReactAddToCalendar"
  }
};

var _reactTransformHmr2 = (0, _reactTransformHmr4.default)({
  filename: "src/ReactAddToCalendar.js",
...
var ReactAddToCalendar = _wrapComponent("ReactAddToCalendar")(function (_React$Component) {
  ...
  _createClass(ReactAddToCalendar, [{
    ...
    value: function renderDropdown() {
      ...
      var items = this.props.listItems.map(function (listItem) {
        ...
        if (self.props.displayItemIcons) {
          ...
          icon = _react3.default.createElement("i", { className: "fa fa-" + currentIcon });
        }
    ...
    value: function renderButton() {
      ...
      if (template[0] !== "textOnly") {
        ...
        buttonIcon = _react3.default.createElement("i", { className: buttonIconClass });
        buttonLabel = iconPlacement === "right" ? _react3.default.createElement(
          "span",
          null,
          buttonLabel + " ",
          buttonIcon
